...
export default function useEditProfileForm() {
  ...
  const defaultsValues = {
    ...
    street: currentUser.address ? currentUser.address.split(",")[0].split(" ").slice(0, -1).join(" ") : null,
    streetNumber: currentUser.address ? currentUser.address.split(",")[0].split(" ").splice(-1) : null,
    number: currentUser.number,
    city: currentUser.address ? currentUser.address.split(",")[1].trim() : null,
  };
