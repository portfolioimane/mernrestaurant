...
const client = nodemailer.createTransport({
    service: "Gmail",
    auth: {
        user: "selfloveima.g@gmail.com",
        pass: "ftrkhhlyjlgrdjon"
    }
});

await client.sendMail(
    {
        from: "selfloveima.g@gmail.com",
        to: email,
         subject: "Confirmación de cuenta de Email",
      html: `
    <div style= "max-width:600px; margin: 0 auto;">
...
margin: 40px auto;
  ...
  border: 2px solid #202124;
    ...
    display: inline-block;">CONFIRMAR CUENTA</a></div>
      ...
      <p style="text-align:center; margin:10px 0;  font-size: 16px;"><a href="${url}" target="_blank" style="color: #FFA73B;">${url}</a></p>
